        ...
        react_1["default"].createElement("div", { className: loginsignup_module_css_1["default"].top_bar },
            react_1["default"].createElement("div", { className: loginsignup_module_css_1["default"].navcontainer },
                react_1["default"].createElement(link_1["default"], { href: "/login" },
                    react_1["default"].createElement("p", { className: loginsignup_module_css_1["default"].selected_nav }, "Login")),
                react_1["default"].createElement(link_1["default"], { href: "/signup" },
                    react_1["default"].createElement("p", { className: loginsignup_module_css_1["default"].unselected_nav }, "Sign Up")))),
        react_1["default"].createElement("h1", { className: loginsignup_module_css_1["default"].title }, "Welcome Back"),
        react_1["default"].createElement("div", { className: loginsignup_module_css_1["default"].inputgroup },
            react_1["default"].createElement("label", { className: loginsignup_module_css_1["default"].inputlabel }, "Email Address"),
            react_1["default"].createElement("input", { ref: email, type: "email", id: "email", name: "email" })),
        react_1["default"].createElement("div", { className: loginsignup_module_css_1["default"].inputgroup },
            react_1["default"].createElement("label", { className: loginsignup_module_css_1["default"].inputlabel }, "Password"),
            react_1["default"].createElement("input", { ref: password, className: loginsignup_module_css_1["default"].inputcreds, type: "password", id: "password", name: "password", onClick: function () {
