...
var Login = function () {
    ...
    return (react_1["default"].createElement("div", null,
        react_1["default"].createElement("div", { className: styles.top_bar },
            react_1["default"].createElement("div", { className: styles.navcontainer },
                react_1["default"].createElement(link_1["default"], { href: "/login" },
                    react_1["default"].createElement("p", { className: styles.selected_nav }, "Login")),
                react_1["default"].createElement(link_1["default"], { href: "/signup" },
                    react_1["default"].createElement("p", { className: styles.unselected_nav }, "Sign Up")))),
        react_1["default"].createElement("h1", { className: styles.title }, "Welcome Back"),
        react_1["default"].createElement("div", { className: styles.inputgroup },
            react_1["default"].createElement("label", { className: styles.inputlabel }, "Email Address"),
            react_1["default"].createElement("input", { ref: email, type: "email", id: "email", name: "email" })),
        react_1["default"].createElement("div", { className: styles.inputgroup },
            react_1["default"].createElement("label", { className: styles.inputlabel }, "Password"),
            react_1["default"].createElement("input", { ref: password, className: styles.inputcreds, type: "password", id: "password", name: "password", onClick: function () {
